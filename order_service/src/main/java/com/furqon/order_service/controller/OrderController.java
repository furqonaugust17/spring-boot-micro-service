package com.furqon.order_service.controller;
...
import com.furqon.order_service.service.OrderService;
...
public class OrderController {
    ...
    public ResponseEntity<List<ResponseTemplate>> getOrderWithProductById(@PathVariable Long id) {
        List<ResponseTemplate> responseTemplate = orderService.getOrderWithProductById(id);
